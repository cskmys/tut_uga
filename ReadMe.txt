tmp: temp folder required by doxygen
man: manuals for each demofinished: contains all the completed
finished/dgen: code with doxygen output
finished/sphinx: code with sphnix output
